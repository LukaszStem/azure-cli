...
def list_profiles(cli_ctx, client, resource_group_name=None):
...
def update_endpoint(cli_ctx, instance,
...
def create_endpoint(cli_ctx, client, resource_group_name, profile_name, name, origins, location=None,
...
def create_custom_domain(cli_ctx, client, resource_group_name, profile_name, endpoint_name, name, hostname,
...
def update_profile(cli_ctx, instance, tags=None):
...
def create_profile(cli_ctx, client, resource_group_name, name,
