...
class CustomResourceOperations(object):
    ...
    def tag_resource(cli_ctx, tags, resource_group_name=None, resource_provider_namespace=None,
                     parent_resource_path=None, resource_type=None, resource_name=None,
                     resource_id=None, api_version=None):
    ...
    def update_policy_definition(policy_definition_name, rules=None, params=None,
        ...
        PolicyDefinition = get_sdk(cli_ctx, ResourceType.MGMT_RESOURCE_POLICY, 'PolicyDefinition', mod='models')
